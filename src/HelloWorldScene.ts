...
export default class HelloWorldScene extends Phaser.Scene {
	...
	create() {
		...
		this.physics.add.overlap(this.player, this.stars,
			this.handleCollectStar, undefined, this)
	...
	private handleHitBomb(player: Phaser.GameObjects.GameObject, 
		...
		private handleCollectStar(player: Phaser.GameObjects.GameObject, 
